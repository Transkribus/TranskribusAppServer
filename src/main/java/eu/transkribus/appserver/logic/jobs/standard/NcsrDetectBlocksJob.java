...
public class NcsrDetectBlocksJob extends ALayoutAnalysisJob {
	private static final Logger logger = LoggerFactory.getLogger(NcsrDetectBlocksJob.class);

	public NcsrDetectBlocksJob(TrpJobStatus job) {
		super(job);
	}
